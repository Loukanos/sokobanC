...
void salvaMovimentos(int m[8][9], int &x, int &y,bool game,char tecla){
...
void lerMatriz(int m[8][9], int &x, int &y){
...
void rodarFase(string nome,int &x, int &y, int &movimentos, bool &game, int m[8][9],int escolha,int m2[8][9], int m3[8][9],int m4[8][9],bool continua,bool &extra,int &retornar){//roda a fase selecionada
...
void reinicializaMatriz(int matriz[8][9],int escolha,int &x, int &y){
    ...
    if ( _kbhit() ){
        ...
        switch(getch())
        {
            case 97://caso fase 1(a), e assim por diante
                ...
                escolha = 1;
                reinicializaMatriz(m,escolha,x,y);//como e o menu de novojogo, a matriz sempre sera reiniciada
            ...
            case 98://[b]fase 2
                ...
                remove("movimentos.txt");//apaga movimentos
                escolha = 2;
                reinicializaMatriz(m2,escolha,x,y);
                continua = true;
                system("cls");
            ...
            case 99://[c]fase 3
                ...
                remove("movimentos.txt");//apaga movimentos
                escolha = 3;
                reinicializaMatriz(m3,escolha,x,y);
                continua = true;
                system("cls");
                iniciaFase(x,y,movimento,game,escolha);
                rodarFase(nome,x,y,movimento,game,m,escolha,m2,m3,m4,continua,extra,retornar);
            ...
            if(escolha ==1){//se caiu na escolha 1, fase 1
                reinicializaMatriz(m,escolha,x,y);
                continua = true;
                system("cls");
                iniciaFase(x,y,movimento,game,escolha);
                rodarFase(nome,x,y,movimento,game,m,escolha,m2,m3,m4,continua,extra,retornar);
            ...
            if(escolha ==4){//se caiu na escolha 4, fase 4
                reinicializaMatriz(m4,escolha,x,y);
                continua = true;
                system("cls");
                iniciaFase(x,y,movimento,game,escolha);
                rodarFase(nome,x,y,movimento,game,m,escolha,m2,m3,m4,continua,extra,retornar);
