...
void lerMovimentosLidos(int m[25][60], int &x, int &y, bool &game, int &movimentos, int &retornar){
...
void menu(string nome,int m[8][9],int m2[8][9], int m3[8][9], int m4[25][60], int movimento, bool continua, int escolha, int x, int y,int linhas, int colunas);//protótipo da função menu para poder realizar a chamada
...
void lerMatrizExtra(int m[25][60], int &x, int &y){
...
void lerPlacar(string nome,int m[8][9],int m2[8][9], int m3[8][9],int m4[25][60], int movimento, bool continua, int escolha,int x, int y,int linhas, int colunas){
...
void imprimeMapa (int m[25][60], int x, int y,int linhas, int colunas){//imprimeMapa o mapa
    ///Posiciona a escrita no início do console
        reposicionaCursor();
...
void movimento(int m[25][60], int &x, int &y, bool &game, int &movimentos){//movimenta o player e as caixas, com colisão 
...
void voltarMenu(string nome,int m[8][9],int m2[8][9], int m3[8][9],int m4[25][60],bool &game, int movimento, bool continua, int escolha, int x, int y,int linhas, int colunas){
...
bool checarVitoria2(string nome,int m[25][60],int movimentos){
...
void rodarFase(string nome,int &x, int &y, int &movimentos, bool &game, int m[8][9],int escolha,int m2[8][9], int m3[8][9],int m4[25][60],bool continua,bool &extra,int &retornar,int linhas, int colunas){//roda a fase selecionada
...
void sobre(string nome,int m[8][9],int m2[8][9], int m3[8][9],int m4[25][60], int movimento, bool continua, int escolha,int x, int y,int linhas, int colunas){//submenu "sobre"
...
void reinicializaMatriz(int matriz[8][9],int m4[25][60],int escolha,int &x, int &y){
...
void menu(string nome,int m[8][9],int m2[8][9], int m3[8][9],int m4[25][60], int movimento, bool continua, int escolha,int x, int y,int linhas,int colunas){//menu principal
